<script  src="../Modulos/Registros/indexValidacion2.js"></script>
    ...
    <?php
            ...
            @$sql60="select * from supervisores";  

            $supervisores=$conexion->query($sql60);          
                            ...
                            <div style="background-color:#3fbbc0;color:#FFFFFF; height:60px;"><div class="title"><h2 >&nbsp; Actualizar Registros</h2></div></div>
                                    ...
                                    <div class="panel-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group ">
                                                <label class="control-label " for="number"></label>
                                                <input class="form-control" id="search" placeholder="Número de Documento" name="CajaNumero1" type="number" onkeypress='return validaNumericos(event)' readonly/>
                                            </div>
                                        ...
                                        <br>
                                            ...
                                            <div class="form-group">
                                                <div>
                                                    <button class="btn btn-primary " type="button" onclick="UpdateRegistro();">
                                                    Ingresar
                                                    </button>
                                                </div>
                                            </div>
